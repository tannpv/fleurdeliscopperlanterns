...
class Mage_Adminhtml_Block_Sales_Totals extends Mage_Sales_Block_Order_Totals
{
    ...
    protected function _initTotals()
    {
        ...
        /**
         * *
         * *  Description:    add addon total
         * *  Author:         tannpv
         * *  Date:           2014/09/02     
         **/
        
        $this->_totals['addontotal'] = new Varien_Object(array(
            'code'      => 'addontotal',
            'value'     => $this->getSource()->getAddonBaseTotal(),
            'base_value'=> $this->getSource()->getAddonBaseTotal(),
            'label'     => $this->helper('sales')->__('Addon Total')
        ));
