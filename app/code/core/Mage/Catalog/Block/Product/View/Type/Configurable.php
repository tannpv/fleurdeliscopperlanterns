        ...
        foreach ($this->getAllowAttributes() as $attribute) {
            ...
            if (is_array($prices)) {
                foreach ($prices as $value) {
                    ...
                    /*
                     * *    Author: tannpv
                     * *    Description update attribute price
                     * *    Date 2014/08/29
                     */

                    $_productId = $options[$attributeId][$value['value_index']][0];
                    $_chidproduct = Mage::getModel('catalog/product')->load($_productId);
                    $price = $_chidproduct->getPrice();
                    $value['pricing_value'] = $price;
...
//            'prices'          => $this->_prices,
            /*
             * *    Author: tannpv
             * *    Description update base price for product
             * *    Date 2014/09/11
             */
