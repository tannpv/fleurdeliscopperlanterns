        ...
        foreach ($attributes as $attribute) {
            ...
            if ($value) {
                if ($value['pricing_value'] != 0) {
                    ...
                    /**
                     * *
                     * *  Description:    get simple product price insted of configuration price
                     * *  Author:         tannpv
                     * *  Date:           2014/08/31     
                     * */
//                    $finalPrice += $product->getConfigurablePrice();
                    $childProduct = Mage::getModel('catalog/product_type_configurable')->getProductByAttributes($selectedAttributes, $product);
                     $_chidproduct = Mage::getModel('catalog/product')->load($childProduct->getId());
                    $finalPrice +=$_chidproduct->getPrice();
