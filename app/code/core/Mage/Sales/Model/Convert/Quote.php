...
class Mage_Sales_Model_Convert_Quote extends Varien_Object {
    ...
    public function toOrder(Mage_Sales_Model_Quote $quote, $order = null) {
        ...
        $order->setIncrementId($quote->getReservedOrderId())
                ...
                /**
                 * *
                 * *  Description:    transfer AddonBaseTotal From Quote to Order
                 * *  Author:         tannpv
                 * *  Date:           2014/09/02     
                 **/
                
                ->setAddonBaseTotal($quote->getAddonBaseTotal());
    ...
    public function itemToOrderItem(Mage_Sales_Model_Quote_Item_Abstract $item) {
        $orderItem = Mage::getModel('sales/order_item')
                ...
                /**
                 * *
                 * *  Description:    transfer addonRowTotal, fleurBasePrice, and FleurBaseRowTotal from quote to order
                 * *  Author:         tannpv
                 * *  Date:           2014/0901     
                 **/
                
                ->setAddonRowTotal($item->getAddonRowTotal())
                ->setFleurBasePrice($item->getFleurBasePrice())
                ->setFleurBaseRowTotal($item->getFleurBaseRowTotal())
        ;
